(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function beauty_cosmetic_store_customizer_label( id, title ) {
			...
			if ( id === 'beauty_cosmetic_store_global_color' || id === 'beauty_cosmetic_store_heading_color' || id === 'beauty_cosmetic_store_paragraph_color') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-beauty_cosmetic_store_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		// Global Color Setting
		beauty_cosmetic_store_customizer_label( 'beauty_cosmetic_store_global_color', 'Global Color' );
		beauty_cosmetic_store_customizer_label( 'beauty_cosmetic_store_heading_color', 'Heading Typography' );
		beauty_cosmetic_store_customizer_label( 'beauty_cosmetic_store_paragraph_color', 'Paragraph Typography' );
