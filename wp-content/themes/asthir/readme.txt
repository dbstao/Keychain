...
The theme has a blank canvas template so you can easily create unique page by page builder.
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1052202

* Screenshot product image three
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/518804

* Screenshot product image four
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1055862


== Changelog ==

= 1.1.6 =
* product page setup for woocommerce
* screenshot changed
...
= 1.1.1 - July 1 2022 =
* New style added in footer
* Some style issue fixed

= 1.1.0 - March 30 2022 =
* Header responsive issue fixed
* New admin style added

= 1.0.9 - November 22 2021 =
* Header responsive issue fixed
* New admin style added

= 1.0.8 - August 23 2021 =
* More flaxiable mobile menu added
* Blank canvas template added
* Fixed some css style issue

= 1.0.7 - may 28 2021 =
* Woo style added
* dynamic version function added

= 1.0.6 - may 05 2021 =
* Footer widget style fixed
* Header cart items color issue fixed
* Icons clickable issue fixed

= 1.0.5 - April 30 2021 =
* Header search style added
* Added cart icon style
* Header Footer bg color change
