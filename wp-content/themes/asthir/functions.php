...
function asthir_scripts()
{
	...
	wp_enqueue_style('asthir-slicknav', get_template_directory_uri() . '/assets/css/slicknav.css', array(), ASTHIR_VERSION, 'all');
	...
	wp_enqueue_script('asthir-jquery.slicknav', get_template_directory_uri() . '/assets/js/jquery.slicknav.js', array(), '1.0', true);
 ...
 */
add_filter('excerpt_more', 'asthir_exerpt_empty_string', 999);
function asthir_exerpt_empty_string($more)
{
	if (is_admin()) {
		return $more;
	}
