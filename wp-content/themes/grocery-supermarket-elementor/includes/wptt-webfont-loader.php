...
if ( ! class_exists( 'Grocery_Supermarket_Elementor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Grocery_Supermarket_Elementor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Grocery_Supermarket_Elementor_WPTT_WebFont_Loader( $url );
