...
?>
<?php if ((get_theme_mod( 'grocery_supermarket_elementor_post_layout','Right Sidebar') == 'Three Columns') || (get_theme_mod( 'grocery_supermarket_elementor_post_layout','Right Sidebar') == 'Four Columns')) : ?> 
  <div class="col-lg-12 col-md-12 col-sm-12">
    <div id="post-<?php the_ID(); ?>" <?php post_class('post-box mb-4'); ?>>
      <div class="box">
        <div class="post-thumbnail">  
          <?php if (get_theme_mod( 'grocery_supermarket_elementor_blog_post_featured_image',true)) : ?>      
              <?php if ( has_post_thumbnail() ) { ?>
                <?php the_post_thumbnail(); ?>
              <?php } else { ?>
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/post-dummy.png' ); ?>" alt="<?php esc_attr_e( 'Post Image', 'grocery-supermarket-elementor' ); ?>">
              <?php }?>
          <?php endif; ?>
        </div>
        <div class="box-content">
          <p class="slider-button mb-0">
            <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php esc_html_e('Read More','grocery-supermarket-elementor'); ?><i class="fas fa-angle-right ms-2"></i></a>
          </p>
        </div>
      </div>
      <div class="post-content-box p-3">
        ...
        <?php echo wp_trim_words( get_the_content(), get_theme_mod('grocery_supermarket_elementor_length_setting','15')); ?>
        </div>
        <div class="post-info">
