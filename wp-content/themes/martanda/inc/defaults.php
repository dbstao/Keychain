...
if ( ! function_exists( 'martanda_get_defaults' ) ) {
	...
	function martanda_get_defaults() {
		$martanda_defaults = array(
			...
			'desktop_site_title_font_size_unit' => 'px',
			'mobile_site_title_font_size_unit' => 'px',
			...
			'desktop_navigation_font_size_unit' => 'px',
			'tablet_navigation_font_size_unit' => 'px',
			...
			'desktop_fixed_side_font_size_unit' => 'px',
