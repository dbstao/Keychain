...
function lifestyle_store_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'lifestyle-store'), esc_html__('Begin Installation', 'lifestyle-store'), 'edit_theme_options', 'lifestyle-store-guide-page', 'lifestyle_store_guide');
}
...
define('LIFESTYLE_STORE_LIVE_DEMO',__('https://trial.ovationthemes.com/lifestyle-store/','lifestyle-store'));
}
if ( ! defined( 'LIFESTYLE_STORE_BUY_PRO' ) ) {
define('LIFESTYLE_STORE_BUY_PRO',__('https://www.ovationthemes.com/products/lifestyle-store-wordpress-theme','lifestyle-store'));
}
if ( ! defined( 'LIFESTYLE_STORE_PRO_DOC' ) ) {
define('LIFESTYLE_STORE_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-lifestyle-store-pro-doc/','lifestyle-store'));
}
if ( ! defined( 'LIFESTYLE_STORE_FREE_DOC' ) ) {
define('LIFESTYLE_STORE_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-lifestyle-store-free-doc/','lifestyle-store'));
}
