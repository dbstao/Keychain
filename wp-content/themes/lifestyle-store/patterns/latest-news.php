...
<!-- wp:heading {"textAlign":"left","level":3,"className":"productsec-heading","style":{"typography":{"textTransform":"capitalize","fontStyle":"normal","fontWeight":"700"},"color":{"text":"#1b1c1e"}},"backgroundColor":"secondary","fontFamily":"josefin_sans"} -->
...
<!-- wp:group {"align":"wide","className":"recent-news-group","backgroundColor":"secondary","layout":{"type":"default"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"background","className":"wow zoomIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group wow zoomIn has-background-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"layout":{"type":"constrained"}} -->
