...
<div class="wp-block-group product-section"><!-- wp:heading {"textAlign":"left","level":3,"className":"productsec-heading","style":{"typography":{"textTransform":"capitalize","fontStyle":"normal","fontWeight":"700"},"color":{"text":"#1b1c1e"}},"backgroundColor":"secondary","fontFamily":"josefin_sans"} -->
<h3 class="wp-block-heading has-text-align-left productsec-heading has-secondary-background-color has-text-color has-background has-josefin-sans-font-family" style="color:#1b1c1e;font-style:normal;font-weight:700;text-transform:capitalize"><?php esc_html_e('Latest Trending','lifestyle-store'); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"className":"wow zoomIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group wow zoomIn"><!-- wp:woocommerce/product-image {"showSaleBadge":false,"imageSizing":"thumbnail","isDescendentOfQueryLoop":true} /-->

<!-- wp:post-title {"textAlign":"center","level":3,"isLink":true,"style":{"spacing":{"margin":{"bottom":"0.75rem","top":"var:preset|spacing|20"}}},"fontSize":"medium","__woocommerceNamespace":"woocommerce/product-query/product-title"} /-->
