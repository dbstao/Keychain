...
/**
 * Title: More Post
 * Slug: lifestyle-store/more-post
 * Categories: lifestyle-store, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','lifestyle-store'); ?></h3>
<!-- /wp:heading -->
