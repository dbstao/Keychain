...
/**
 * Title: Archives
 * Slug: lifestyle-store/archive
 * Categories: lifestyle-store, archive
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e('Sorry, no post exist...','lifestyle-store'); ?></h3>
<!-- /wp:heading -->
