...
if (!function_exists('ev_bike_shop_enqueue_scripts')) {
	...
	function ev_bike_shop_enqueue_scripts() {
		...
		wp_add_inline_style( 'ev-bike-shop-style',$ev_bike_shop_theme_custom_setting_css );
...
if (!function_exists('ev_bike_shop_after_setup_theme')) {
	...
	function ev_bike_shop_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] )) {
			add_action('admin_notices', 'ev_bike_shop_activation_notice');
		}
...
function ev_bike_shop_activation_notice() {
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			...
			echo '<div class="notice-content">';
				echo '<h2>'. esc_html__( 'Welcome to WPElemento', 'ev-bike-shop' ) .'</h2>';
				echo '<p>'. esc_html__( 'Thank you for choosing EV Bike Shop .To setup the theme, please visit the get started page.', 'ev-bike-shop' ) .'</p>';
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=ev_bike_shop_about' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'ev-bike-shop' ) .'</a></span>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
}
...
if (!function_exists('ev_bike_shop_widgets_init')) {
	...
	function ev_bike_shop_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Page Sidebar','ev-bike-shop'),
			'id'   => 'sidebar-2',
			'description'   => esc_html__('This sidebar will be shown next to the content.', 'ev-bike-shop'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar three','ev-bike-shop'),
			'id'   => 'sidebar-3',
			'description'   => esc_html__('This sidebar will be shown on blog pages.', 'ev-bike-shop'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 1','ev-bike-shop'),
			'id'   => 'footer1-sidebar',
			'description'   => esc_html__('It appears in the footer 1.', 'ev-bike-shop'),
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 2','ev-bike-shop'),
			'id'   => 'footer2-sidebar',
			'description'   => esc_html__('It appears in the footer 2.', 'ev-bike-shop'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 3','ev-bike-shop'),
			'id'   => 'footer3-sidebar',
			'description'   => esc_html__('It appears in the footer 3.', 'ev-bike-shop'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 4','ev-bike-shop'),
			'id'   => 'footer4-sidebar',
			'description'   => esc_html__('It appears in the footer 4.', 'ev-bike-shop'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
...
define('EV_BIKE_SHOP_FREE_THEME_DOC',__('https://preview.wpelemento.com/theme-documentation/ev-bike-shop/','ev-bike-shop'));
define('EV_BIKE_SHOP_SUPPORT',__('https://wordpress.org/support/theme/ev-bike-shop/','ev-bike-shop'));
define('EV_BIKE_SHOP_REVIEW',__('https://wordpress.org/support/theme/ev-bike-shop/reviews/','ev-bike-shop'));
define('EV_BIKE_SHOP_BUY_NOW',__('https://www.wpelemento.com/products/bike-shop-wordpress-theme','ev-bike-shop'));
define('EV_BIKE_SHOP_LIVE_DEMO',__('https://preview.wpelemento.com/ev-bike-shop/','ev-bike-shop'));
define('EV_BIKE_SHOP_THEME_BUNDLE',__('https://www.wpelemento.com/products/wordpress-theme-bundle','ev-bike-shop'));
