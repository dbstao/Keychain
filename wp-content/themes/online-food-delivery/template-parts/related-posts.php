					    ...
					    <div class="services-box">    
					      	...
					      	<div class="lower-box">
						        ...
						        <?php if(get_the_excerpt()) { ?>
						            <p><?php $online_food_delivery_excerpt = get_the_excerpt(); echo esc_html( online_food_delivery_string_limit_words( $online_food_delivery_excerpt, esc_attr(get_theme_mod('online_food_delivery_related_post_excerpt_number','20')))); ?><?php echo esc_html( get_theme_mod('online_food_delivery_button_excerpt_suffix','[...]') ); ?></p>
						        <?php }?>
