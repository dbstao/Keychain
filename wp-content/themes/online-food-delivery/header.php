		...
		<div id="header">
			<div class="container">
	            ...
	            <?php if( get_theme_mod( 'online_food_delivery_site_title',true) != '') { ?>
		            ...
		            <?php endif; ?>
			        <?php }?>
			        <?php if( get_theme_mod( 'online_food_delivery_site_tagline',false) != '') { ?>
		            <?php
					...
					<div class="<?php if( get_theme_mod( 'online_food_delivery_topbar_phoneno') != '') { ?>col-lg-5 col-md-3<?php } else {?>col-lg-7 col-md-6 <?php }?> col-6 align-self-center px-md-0">
						<div class="menubox <?php if( get_theme_mod( 'online_food_delivery_sticky_header', false) != '' || get_theme_mod('online_food_delivery_responsive_sticky_header',false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?> ps-lg-5">
							<?php ?>
						   	<div class="toggle-menu responsive-menu text-md-end">
			           	<button role="tab" onclick="online_food_delivery_menu_open()"><i class="<?php echo esc_attr(get_theme_mod('online_food_delivery_responsive_open_menu_icon','fas fa-bars'));?>"></i><?php echo esc_html( get_theme_mod('online_food_delivery_open_menu_label', __('Open Menu','online-food-delivery'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','online-food-delivery'); ?></span></button>
			         	</div>
			         	<div id="menu-sidebar" class="nav side-menu container">
			            <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'online-food-delivery' ); ?>">
			              ...
			              ?>
			              <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="online_food_delivery_menu_close()"><?php echo esc_html( get_theme_mod('online_food_delivery_close_menu_label', __('Close Menu','online-food-delivery'))); ?><i class="<?php echo esc_attr(get_theme_mod('online_food_delivery_responsive_close_menu_icon','fas fa-times'));?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','online-food-delivery'); ?></span></a>
			            </nav>
			          </div>  
			      	<?php ?>
			      </div>
