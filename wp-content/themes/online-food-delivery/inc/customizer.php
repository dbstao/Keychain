...
function online_food_delivery_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('online_food_delivery_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Demo','online-food-delivery') ."</h3><p>". esc_html('Our premium version of Online Food Delivery has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.','online-food-delivery') ."</p> <a target='_blank' href='". esc_url('https://preview.themescaliber.com/online-food-delivery-pro/') ." '>". esc_html('View Demo','online-food-delivery') ."</a>",
		...
		$wp_customize->add_control('online_food_delivery_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Support','online-food-delivery') ."</h3><p>". esc_html('Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.','online-food-delivery') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/online-food-delivery/') ." '>". esc_html('Support Forum','online-food-delivery') ."</a>",
			'section'=> 'online_food_delivery_about_theme'
		));
		...
		$wp_customize->add_control('online_food_delivery_review_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Review','online-food-delivery') ."</h3><p>". esc_html('If you enjoy using our theme, we’d love to hear your feedback. please leave us a review.','online-food-delivery') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/online-food-delivery/reviews/#new-post') ." '>". esc_html('Rate & Review','online-food-delivery') ."</a>",
			'section'=> 'online_food_delivery_about_theme'
		));			
    ...
    $wp_customize->add_control('online_food_delivery_menu_settings_premium_features', array(
    	'type'=> 'hidden',
        'description' => "<h3>". esc_html('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html('Menu Background Colors','online-food-delivery') ."</li>
        		<li>". esc_html('Menu Item Fonts','online-food-delivery') ."</li>
        		<li>". esc_html('Responsive Menu Colors','online-food-delivery') ."</li>
        		<li>". esc_html('Header Search Icons Colors','online-food-delivery') ."</li>
        		<li>". esc_html('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html('Upgrade Now','online-food-delivery') ."</a>",
        'section' => 'online_food_delivery_header'
        )
    );
    ...
    $wp_customize->add_control('online_food_delivery_category_settings_premium_features', array(
        ...
        'description' => "<h3>". esc_html('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html('Content Color Option','online-food-delivery') ."</li>
        		<li>". esc_html('Content Font Option','online-food-delivery') ."</li>
        		<li>". esc_html('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html('Upgrade Now','online-food-delivery') ."</a>",
        'section' => 'online_food_delivery_food_category_section'
	...
	$wp_customize->add_section( 'online_food_delivery_button_option', array(
		'title' => __('Button Settings','online-food-delivery'),
		'panel' => 'online_food_delivery_panel_id',
	));
    ...
    $wp_customize->add_control('online_food_delivery_post_settings_premium_features', array(
        ...
        'description' => "<h3>". esc_html('More Features in the Premium Version!','online-food-delivery') ."</h3>
        	<ul>
        		<li>". esc_html('Section Heading Options','online-food-delivery') ."</li>
        		<li>". esc_html('Animated Elements Colors','online-food-delivery') ."</li>
        		<li>". esc_html('... and Other Premium Features','online-food-delivery') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/products/food-ordering-wordpress-theme') ." '>". esc_html('Upgrade Now','online-food-delivery') ."</a>",
        'section' => 'online_food_delivery_blog_post'
