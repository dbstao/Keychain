 ...
 */
/**
 * Class Online_Food_Delivery_Customizer_Upsell_Section
 */
class Online_Food_Delivery_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Online_Food_Delivery_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Online_Food_Delivery_Customizer_Upsell_Section' );
