...
<div class="wrapper-info">  
    <div class="tab-sec">
		...
		<div  id="tc_index" class="tabcontent">
			...
			<div class="col-tc-6">
				<P><?php esc_html_e( 'Online food delivery is a phenomenal and bold theme that works on any platform. In the world of the internet, everyone wants their business online. So, this theme is your chance to do your business online with no effort. The theme is responsive, and users can easily operate with their mobile phones. The theme can be used for Restaurants, Cafes, Food Services, Takeout, Catering, Delivery, Food Trucks, Meal Plans, Eateries, Fast Food, Dine-In, Gourmet, Grub, Bistros, Culinary. This fantastic theme is suitable for any food delivery company, grocery store, or supermarket. Users can use this theme according to their desire and wish as it is completely customizable. The theme is user-friendly, with all the necessary plugins. This theme is great for cloud kitchens, takeouts, pizza shops, Burger shops, ice cream parlours.The layout of this theme is niche specific. Users can also change background color, images, texts, or anything according to their choice. This SEO-friendly online food delivery theme is perfect for beginners to start their online journey. The clean-coded theme is the one where you don’t need to learn any coding language. So, this clean code theme can be used without any coding skills. The theme is loaded with features and customization options. Such as the theme includes responsive design, favicon, logo, title, tagline customization, advanced Color options, 100+ Font Family Options, Background Image Option, Simple and Mega Menu Option, Enable-Disable options on all sections, and many more.', 'online-food-delivery' ); ?></P>
			</div>
    	</div>
