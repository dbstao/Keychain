...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'shop_archive_sidebar',
	array(
		'label'   => esc_html__( 'Sidebar', 'emoza-woocommerce' ),
		'section' => 'woocommerce_product_catalog',
		'choices' => array(
			'no-sidebar' 		=> esc_html__( 'No sidebar', 'emoza-woocommerce' ),
...
$wp_customize->add_control(
    new Emoza_Accordion_Control(
        ...
        array(
            'label'         => esc_html__( 'Product card', 'emoza-woocommerce' ),
            'section'       => 'woocommerce_product_catalog',
...
$wp_customize->add_control( new \Kirki\Control\Sortable( $wp_customize, 'shop_card_elements', array(
	...
	'section' 			=> 'woocommerce_product_catalog',
	'choices' 			=> array(
		'woocommerce_template_loop_product_title' 	=> esc_html__( 'Title', 'emoza-woocommerce' ),
...
$wp_customize->add_control(
    new Emoza_Accordion_Control(
        ...
        'accordion_shop_sale_tag',
        array(
            'label'         => esc_html__( 'Sale tag', 'emoza-woocommerce' ),
            'section'       => 'woocommerce_product_catalog',
...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'shop_categories_alignment',
	array(
		'label'   => esc_html__( 'Text alignment', 'emoza-woocommerce' ),
		'section' => 'woocommerce_product_catalog',
		'choices' => array(
...
$wp_customize->add_control( new Emoza_Responsive_Slider( $wp_customize, 'shop_categories_radius',
	array(
		'label' 		=> esc_html__( 'Border radius', 'emoza-woocommerce' ),
		'section' 		=> 'woocommerce_product_catalog',
		'is_responsive'	=> 0,
...
$wp_customize->add_control( new Emoza_Divider_Control( $wp_customize, 'shop_cart_divider_1',
		array(
			'section' 			=> 'emoza_section_shop_cart',
		)
	)
