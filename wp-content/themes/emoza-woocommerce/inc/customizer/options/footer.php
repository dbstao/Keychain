...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'footer_widget_sections',
		array(
			'description' 	=> '<span class="customize-control-title" style="font-style: normal;">' . esc_html__( 'Footer widget areas', 'emoza-woocommerce' ) . '</span><a class="footer-widget-area-link footer-widget-area-link-1" href="javascript:wp.customize.section( \'sidebar-widgets-footer-1\' ).focus();">' . esc_html__( 'Widget area 1', 'emoza-woocommerce' ) . '<span class="dashicons dashicons-arrow-right-alt2"></span></a><a class="footer-widget-area-link footer-widget-area-link-2" href="javascript:wp.customize.section( \'sidebar-widgets-footer-2\' ).focus();">' . esc_html__( 'Widget area 2', 'emoza-woocommerce' ) . '<span class="dashicons dashicons-arrow-right-alt2"></span></a><a class="footer-widget-area-link footer-widget-area-link-3" href="javascript:wp.customize.section( \'sidebar-widgets-footer-3\' ).focus();">' . esc_html__( 'Widget area 3', 'emoza-woocommerce' ) . '<span class="dashicons dashicons-arrow-right-alt2"></span></a><a class="footer-widget-area-link footer-widget-area-link-4" href="javascript:wp.customize.section( \'sidebar-widgets-footer-4\' ).focus();">' . esc_html__( 'Widget area 4', 'emoza-woocommerce' ) . '<span class="dashicons dashicons-arrow-right-alt2"></span></a>',
			'section' 		=> 'emoza_section_footer_widgets',
		)
	)
);
...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'footer_widgets_divider_width',
	array(
		...
		'choices' 	=> array(
			...
			'fullwidth' 	=> esc_html__( 'Fullwidth', 'emoza-woocommerce' ),
		),
		'active_callback' 	=> 'emoza_callback_footer_widgets_divider'
	)
) );
...
$wp_customize->add_control(
	new Emoza_Tab_Control (
		...
		array(
			...
			'controls_general'		=> json_encode( array( '#customize-control-footer_divider_9', '#customize-control-footer_divider_8', '#customize-control-footer_credits_container', '#customize-control-footer_credits', '#customize-control-social_profiles_footer') ),
