...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'headings_text_transform',
	array(
...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'headings_text_decoration',
	array(
		'label'   => esc_html__( 'Text decoration', 'emoza-woocommerce' ),
		'section' => 'emoza_section_typography_headings',
		'choices' => array(
			'none' 			=> '-',
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h1_title',
		array(
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h2_title',
		array(
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h3_title',
		array(
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h4_title',
		array(
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h5_title',
		array(
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'h6_title',
		array(
...
$wp_customize->add_section(
	...
	array(
		'title'      => esc_html__( 'Body', 'emoza-woocommerce'),
		'panel'      => 'emoza_panel_typography',
	)
);
...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'body_text_transform',
	array(
		'label'   => esc_html__( 'Text transform', 'emoza-woocommerce' ),
		'section' => 'emoza_section_typography_body',
		'choices' => array(
...
$wp_customize->add_control( new Emoza_Radio_Buttons( $wp_customize, 'body_text_decoration',
	array(
		'label'   => esc_html__( 'Text decoration', 'emoza-woocommerce' ),
		'section' => 'emoza_section_typography_body',
		'choices' => array(
...
$wp_customize->add_control( new Emoza_Divider_Control( $wp_customize, 'typography_divider_2',
		array(
			'section' 		=> 'emoza_section_typography_body',
		)
	)
...
$wp_customize->add_control( new Emoza_Text_Control( $wp_customize, 'body_title',
		array(
			'label'			=> esc_html__( 'Body', 'emoza-woocommerce' ),
			'section' 		=> 'emoza_section_typography_body',
		)
	)
);
