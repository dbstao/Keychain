...
class Emoza_Typography_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'emoza-select2-js', get_template_directory_uri() . '/inc/customizer/controls/typography/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_style( 'emoza-select2-css', get_template_directory_uri() . '/inc/customizer/controls/typography/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control popover-block">
					...
					<div class="google-fonts">
						<div class="font-control-title"><strong><?php esc_html_e( 'Font family', 'emoza-woocommerce' ) ?></strong></div>
					...
					<div class="font-control-title w50"><strong><?php esc_html_e( 'Font weight', 'emoza-woocommerce' ) ?></strong></div>
