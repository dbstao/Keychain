    ...
    var Emoza_Accordion = {
        ...
        events: function(){
            ...
            $( document ).on('click', '.control-section', function(e){
                ...
                $section.find('.emoza-accordion-title').each(function(i){
                    ...
                    if( typeof lastSelected === "undefined" && i == 0 ) {
                        $(this).addClass('expanded');
                        $(this).closest('.customize-control').next().removeClass('emoza-accordion-hide');
                    }
                });
            });
        ...
        showOrHide: function( $this, status ) {
            ...
            for( var i = 0; i < elements.length; i++ ) {
                ...
                $( '#'+elements[i] ).addClass('emoza-accordion-item');
