		...
		<div class="notice notice-success" style="position:relative;">
			<p>
				...
				printf(
					...
					esc_html__(
						'Hey, %1$s! You\'ve been using Emoza for more than two weeks now and we hope you\'re happy with it. If you have a few minutes, we would love to get a 5 star review from you.', 'emoza-woocommerce'
					),
			...
			<p>
				<a href="https://wordpress.org/support/theme/emoza-woocommerce/reviews/?filter=5#new-post" class="btn button-primary" target="_blank"><?php esc_html_e( 'Sure', 'emoza-woocommerce' ); ?></a>

				<a href="?delay_emoza_disable_review_notice_partially=0" class="btn button-secondary"><?php esc_html_e( 'Maybe later', 'emoza-woocommerce' ); ?></a>

				<a href="?nag_emoza_disable_review_notice=0" class="btn button-secondary"><?php esc_html_e( 'I already did', 'emoza-woocommerce' ); ?></a>
			</p>
