...
emoza.navigation = {
  init: function init() {
    ...
    var offCanvas = document.getElementsByClassName('emoza-offcanvas-menu')[0]; // Return early if the navigation don't exist.
...
emoza.quickView = {
  init: function init() {
    var button = document.querySelectorAll('.emoza-quick-view'),
        ...
        popupContent = document.querySelector('.emoza-quick-view-popup-content-ajax'); // If quick view is not enabled
    ...
    for (var i = 0; i < button.length; i++) {
      button[i].addEventListener('click', function (e) {
        ...
        ajax.open('POST', emoza_woocommerce.ajaxurl, true);
