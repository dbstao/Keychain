...
define('HOOPOE_THEME_URL','https://wwwows.com/product/hoopoe-wordpress-theme/');
define('HOOPOE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('HOOPOE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'hoopoe_admin_theme_page_more_features' ) ) {
	function hoopoe_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Hoopoe Premium', 'hoopoe' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'hoopoe' ); ?></p>
    <a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Hoopoe Premium', 'hoopoe' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'hoopoe_admin_theme_page_title' ) ) {
	function hoopoe_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Hoopoe WordPress Theme', 'hoopoe' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Hoopoe! Check all the theme features.', 'hoopoe' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'hoopoe' );?></h2>
</div>
<?php
	}
}    
 
// Hoopoe admin page content   
if ( ! function_exists( 'hoopoe_admin_theme_page' ) ) {
	function hoopoe_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php hoopoe_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Free', 'hoopoe' ); ?></span><?php esc_html_e( ' Hoopoe features', 'hoopoe' ); ?></h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'hoopoe' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'hoopoe' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'hoopoe' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'hoopoe' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(HOOPOE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'hoopoe' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Premium', 'hoopoe' ); ?></span><?php esc_html_e( ' Hoopoe features', 'hoopoe' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'hoopoe' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Additional blocks', 'hoopoe' ); ?></span><?php esc_html_e( ' for Hoopoe premium', 'hoopoe' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'hoopoe' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'hoopoe' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php hoopoe_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'hoopoe' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'hoopoe' ); ?></p>
        <a href="<?php echo esc_url(HOOPOE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'hoopoe' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'hoopoe' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'hoopoe' ); ?></p>
        <a href="<?php echo esc_url(HOOPOE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'hoopoe' ); ?></a>
    </div>
</div>
<?php
	}
