...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $aster_photography__gallery_shortcode = get_post_gallery();

		    if (!empty($aster_photography__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($aster_photography__gallery_shortcode) . '</div>';
		    }
		?>
