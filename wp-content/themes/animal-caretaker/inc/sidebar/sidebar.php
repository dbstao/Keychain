...
function animal_caretaker_widgets_init() {
	...
	register_sidebar( array(
		'name' => esc_html__( 'Sidebar 1 Widget Area', 'animal-caretaker' ),
		'id' => 'sidebar1',
		'description' => esc_html__( 'Sidebar 1 widget area', 'animal-caretaker' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h5 class="widget-title">',
		'after_title' => '</h5><span class="animate-border border-black"></span>',
	...
	register_sidebar( array(
		'name' => esc_html__( 'Sidebar 2 Widget Area', 'animal-caretaker' ),
		'id' => 'sidebar2',
		'description' => esc_html__( 'Sidebar 2 widget area', 'animal-caretaker' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h5 class="widget-title">',
		'after_title' => '</h5><span class="animate-border border-black"></span>',
