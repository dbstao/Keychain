...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
	<?php if ( has_post_thumbnail() ) { ?> 
		<div class="post-thumb">
			<?php if ( true == get_theme_mod( 'animal_caretaker_post_image_on_off', 'on' ) ) : ?>
	...
	<div class="post-content">
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_heading_on_off', 'on' ) ) : ?>
		<?php  
			if ( is_single() ) :
		...
		?>
		<?php endif; ?>
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_content_on_off', 'on' ) ) : ?>
			<p><?php echo wp_trim_words( get_the_content(), get_theme_mod('animal_caretaker_post_content_limit',15) );?></p>
		<?php endif; ?>
	</div>
	<ul class="meta-info">
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_date_on_off', 'on' ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_comment_on_off', 'on' ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_author_on_off', 'on' ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( true == get_theme_mod( 'animal_caretaker_post_categories_on_off', 'on' ) ) : ?>
