...
<?php if ( is_active_sidebar( 'footer-widget-area' ) ) { ?>
    <?php if ( true == get_theme_mod( 'animal_caretaker_footer_widgets_display_setting', 'off' ) ) : ?>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-lg-0 mb-4">
					        <aside id="archives-3" class="widget widget_archive">
					            <h5 class="widget-title"><?php esc_html_e( 'Archives List', 'animal-caretaker' ); ?></h5>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-lg-0 mb-4">
                        	<aside id="pages-2" class="widget widget_pages">
							    <h5 class="widget-title"><?php esc_html_e('Our Categories', 'animal-caretaker'); ?></h5>
							    <span class="animate-border border-black"></span>
							    <ul>
							        <?php
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-lg-0 mb-4">
					        <aside id="recent-posts-2" class="widget widget_recent_entries">
							    <h5 class="widget-title"><?php esc_html_e('Recent Posts', 'animal-caretaker'); ?></h5>
							    <span class="animate-border border-black"></span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-lg-0 mb-4">
							<aside id="tag_cloud-2" class="widget widget_tag_cloud">
							    <h5 class="widget-title"><?php esc_html_e('Tag Cloud', 'animal-caretaker'); ?></h5>
							    <span class="animate-border border-black"></span>
...
============================= -->
<?php 
	if ( ! defined( 'ANIMAL_CARETAKER_FREE_LINK' ) ) {
		define('ANIMAL_CARETAKER_FREE_LINK',__('https://www.mishkatwp.com/themes/free-animal-wordpress-theme/','animal-caretaker'));
	}
	$animal_caretaker_copyright_content   = get_theme_mod('copyright_content','Copyright &copy; [current_year] [site_title] | Powered by [theme_author]');
				...
				<p class="mb-0">
					<?php 
						$animal_caretaker_copyright_allowed_tags = array(
							...
							'[site_title]'   => '<a href="' . esc_url( ANIMAL_CARETAKER_FREE_LINK ) . '" target="_blank">'.$animal_caretaker_copyright_content_text.'</a>',
