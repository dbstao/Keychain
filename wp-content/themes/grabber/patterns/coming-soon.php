...
/**
 * Title: coming-soon
 * Slug: grabber/coming-soon
 * Categories: hidden
 * Inserter: no
 */
?>
<!-- wp:woocommerce/coming-soon {"color":"#a6cbff","className":"wp-block-woocommerce-background-color"} -->
...
<div class="wp-block-group woocommerce-coming-soon-banner-container"><!-- wp:group {"tagName":"header","align":"wide","className":"woocommerce-coming-soon-header has-background","style":{"spacing":{"padding":{"top":"3px","bottom":"20px"}}},"layout":{"type":"constrained"}} -->
<header class="wp-block-group alignwide woocommerce-coming-soon-header has-background" style="padding-top:3px;padding-bottom:20px"><!-- wp:group {"align":"wide","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
...
<div class="wp-block-group woocommerce-coming-soon-social-login"><!-- wp:social-links {"iconColor":"contrast","iconColorValue":"#111111","className":"is-style-logos-only","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"blockGap":{"left":"18px"}}}} -->
...
<main class="wp-block-group"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"align":"wide","className":"woocommerce-coming-soon-banner","fontFamily":"inter"} -->
<h1 class="wp-block-heading alignwide has-text-align-center woocommerce-coming-soon-banner has-inter-font-family"><?php esc_html_e('Pardon our dust! We\'re working on something amazing — check back soon!', 'grabber');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></main>
<!-- /wp:group -->
...
<p class="has-text-align-center has-contrast-2-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('&nbsp;', 'grabber');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --><style>
    ...
    .coming-soon-cover .wp-block-cover__background {
        background-color: #a6cbff !important;
    }
