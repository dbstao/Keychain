...
= 1.1.11 =
* Front page setup for woocommerce products display 
* Now banner show shop homepage and blog homepage 
* Sticky widget feature added


= 1.1.8 =
* Removed extra Cusomizer style 

= 1.1.7 =
* Menu items color style issue fixed
* Cusomizer style issue fixed

= 1.1.4 =
* Posts read moer link added with change options
* Added new style
...
= 1.0.20 - june 14 2021 =
* Added option for blog comments

= 1.0.18 - March 29 2021 =
* Fixed footer widget title style

= 1.0.17 - March 3 2021 =
* Shop page home issue fixed.
* Bradcump issue fixed.
