	...
	function beshop_about_setup()
	{
		...
		$config = array(
			...
			'recommended_actions'        => array(
				...
				'content'            => array(
					'one-click' => array(
						'title'       => __('BeBoost Demo Improt', 'beshop'),
	...
	<div class="mgadin-hero">
		<div class="mge-info-content">
			...
			<div class="mge-info-desc">
				<div><?php printf(esc_html__('You are using %1$s free version. Upgrade your website experience by moving from the BeShop free version to BeShop Pro. Elevate your website to new heights with BeShop Pro, transforming it into a sophisticated and high-performance masterpiece. Benefit from advanced SEO optimization, lightning-fast speed, an array of stunning features, and the flexibility of unlimited color schemes to ensure your website stands out with uniqueness!', 'beshop'), $current_theme_name); ?></div>
				<div class="mge-offer"><?php esc_html_e('🌟 Incredible Offer Alert! Save 30% on the Beshop Pro Theme Lifetime with Coupon Code "wpteam30%off"! 🚀', 'beshop'); ?></div>
			</div>
...
function beshop_new_optins_texts()
{
	...
	$hide_date = get_option('beshop_info_text');
	if (!empty($hide_date)) {
...
function beshop_new_optins_texts_init()
{
	if (isset($_GET['besnotice']) && $_GET['besnotice'] == 1) {
		update_option('beshop_info_text', current_time('mysql'));
	}
