					...
					<div class="thunk-posts-description ">
						...
						<div class="thunk-post-comments">
							<div class="thunk-comments-icon">
								<span class="thunk-comments"><a href="<?php comments_link(); ?>" title=""><?php comments_popup_link(esc_html('0','daraz-store'), esc_html('1','daraz-store'), esc_html('%','daraz-store')); ?></a></span>
							</div>
						</div>
					    </div>
